export default function spacecta({ headlineone, quote, buttontext }) {
  return (
    <div className="grid grid-cols-3 bg-slate-100	px-10">
      <div>
      <span className="text-2xl">{headlineone}</span>  
        <div>
          <ul>
            <li>Bullet point</li>
            <li>Bullet point</li>
      ...
      <div className="linequote "></div>
</div>
      <div className="flex flex-col justify-center align-center quotebox ">
